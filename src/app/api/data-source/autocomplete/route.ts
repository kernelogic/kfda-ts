...
import { dataSourceAutocompleteController } from 'src/features/dataSource/controllers/dataSourceAutocompleteController';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const payload = await dataSourceAutocompleteController(query, context);
