...
import { dataCapImporterController } from 'src/features/dataCap/controllers/dataCapImporterController';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const payload = await dataCapImporterController(body, context);
