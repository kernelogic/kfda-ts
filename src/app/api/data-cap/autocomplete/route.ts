...
import { dataCapAutocompleteController } from 'src/features/dataCap/controllers/dataCapAutocompleteController';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const payload = await dataCapAutocompleteController(query, context);
