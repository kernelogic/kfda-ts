...
import { dataSetAutocompleteController } from 'src/features/dataSet/controllers/dataSetAutocompleteController';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const payload = await dataSetAutocompleteController(query, context);
