...
import { dataSetImporterController } from 'src/features/dataSet/controllers/dataSetImporterController';
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const payload = await dataSetImporterController(body, context);
